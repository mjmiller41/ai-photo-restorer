...
const RESTORATION_PROMPT = `You are an archival-grade digital restoration specialist. Your mission is to restore this antique photograph with the utmost precision and care, treating it as a priceless historical document.
...
const COLORIZE_PROMPT = `You are an archival-grade digital restoration specialist and a historical colorist. Your mission is to restore and colorize this antique photograph with the utmost precision and care, treating it as a priceless historical document.
